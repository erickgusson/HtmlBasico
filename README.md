...
<head>
    ...
    <title>HTMl Básico - Erick Vinicius gusson</title>
</head>
<body>
    <h1>Olá mundo</h1>
    <hr>
    <p>Estou me sentindo um hacker agora enquanto escrevo essas linhas de código utilizando html</p>

    <h2>HTML Básico</h2>
    <p>Aqui tem uma lista dos conteúdos básicos do HTML</p>
    <p>
        Você pode
        escrever um
        parágrafo
        de qualquer jeito.
        Basta colocar tudo
        no meio do parte de tags &lt; p &gt; e &lt; /p &gt;
    </p>
    <p>
        Se precisar quebrar
    ...
    <p>
        ...
        &uarr;--> Seta acima<br>
        &rarr;--> Seta direita<br>
        &darr; --> Seta abaixo<br>
    </p>

    <h2>Emojis</h2>
    <p>Vamos agora utilizar </p>
    <p>
        &#x1F390
        &#x1f5ff
        &#x1F610
    ...
    <h2>Imagens</h2>
    <p>Podemos ter imagens de tipos variados: gif, jpg, png entre outros.</p>
    <p>A imagem pode estar localizada no mesmo local do arquivo index, denro de uma pasta, ou mesmo, em um site na internet</p>
    <p>Vamos começar colocando uma imagem que esta em um site: </p>
